(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const a of document.querySelectorAll('link[rel="modulepreload"]'))n(a);new MutationObserver(a=>{for(const s of a)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(a){const s={};return a.integrity&&(s.integrity=a.integrity),a.referrerPolicy&&(s.referrerPolicy=a.referrerPolicy),a.crossOrigin==="use-credentials"?s.credentials="include":a.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function n(a){if(a.ep)return;a.ep=!0;const s=t(a);fetch(a.href,s)}})();class M{constructor(e="Menti",t=!1){this.baseUrl="/Mentee_site/",this.siteName=e,this.isLoggedIn=t}render(){return`
    ...
    `}}class B{constructor(e="Menti"){this.siteName=e}render(){return`
      <footer class="footer">
        <div class="container">
...
<p class="business-note" style="margin-top: 2rem; padding: 0.5rem 0; background: transparent; border: none; color: #44516f; font-weight: 500; text-align: center; font-size: 1rem;">
  ...
  `}renderTestimonials(){return`
    ...
    `}render(){const e=document.getElementById("header"),t=document.getElementById("main-content"),n=document.getElementById("footer");e&&(e.innerHTML=this.header.render()),t&&(t.innerHTML=`
        ...
        ${this.renderCTA()}
      `),n&&(n.innerHTML=this.footer.render()),this.attachEventListeners()}attachEventListeners(){var t,n,a,s,o,c,r,p;const e=document.querySelector(".mobile-menu-btn");e&&e.addEventListener("click",()=>{const i=document.querySelector(".nav-links");i==null||i.classList.toggle("show")}),this.initTeamCarousel(),this.initTestimonialsCarousel(),(t=document.getElementById("downloadBtn"))==null||t.addEventListener("click",()=>{alert("Додаток буде доступний скоро! Слідкуйте за оновленнями.")}),(n=document.getElementById("ctaDownloadBtn"))==null||n.addEventListener("click",()=>{alert("Додаток буде доступний скоро! Слідкуйте за оновленнями.")}),["volunteerBtn","ctaVolunteerBtn","volunteerCallBtn","floatingCtaBtn"].forEach(i=>{var l;(l=document.getElementById(i))==null||l.addEventListener("click",()=>{this.openModal("mentor")})}),(a=document.getElementById("registerBtn"))==null||a.addEventListener("click",()=>{this.openModal("register")}),(s=document.getElementById("loginLink"))==null||s.addEventListener("click",i=>{i.preventDefault(),this.openModal("login")}),(o=document.getElementById("volunteerAskBtn"))==null||o.addEventListener("click",()=>{alert("Зв'яжіться з нами: reznikovaolha@gmail.com або +3800969007678")}),(c=document.getElementById("donateBtn"))==null||c.addEventListener("click",()=>{alert("Дякуємо за інтерес! Зв'яжіться з нами: reznikovaolha@gmail.com")}),(r=document.getElementById("impactMoreBtn"))==null||r.addEventListener("click",()=>{alert("Прозорість — наша цінність. 100$ = 5 менторських сесій для дитини з прифронтової зони.")}),(p=document.getElementById("allTestimonialsBtn"))==null||p.addEventListener("click",()=>{alert("Всі відгуки будуть доступні незабаром! Слідкуйте за оновленнями.")}),document.querySelectorAll(".top-switch-btn").forEach(i=>{i.addEventListener("click",()=>{const l=i.dataset.audience;!l||l===this.activeAudience||(this.activeAudience=l,this.render())})})}initTeamCarousel(){const e=document.getElementById("teamPrev"),t=document.getElementById("teamNext"),n=document.getElementById("teamCenterCard"),a=document.getElementById("teamSlotTopLeft"),s=document.getElementById("teamSlotTopRight"),o=document.getElementById("teamSlotBottomLeft"),c=document.getElementById("teamSlotBottomRight"),r=document.querySelectorAll(".team-dot");if(!e||!t||!n||!a||!s||!o||!c)return;const p=this.data.teamMembers;let i=0,l=null;const u=d=>(d+p.length)%p.length,h=d=>p[u(d)],k=d=>`
  ...
  `,y=d=>{const v=d==null?void 0:d.querySelector("button[data-index]");if(!v)return;const m=Number(v.dataset.index),f=()=>{i=m,b()};v.addEventListener("click",f),v.addEventListener("mouseenter",()=>{l&&window.clearTimeout(l),l=window.setTimeout(()=>{f()},160)}),v.addEventListener("mouseleave",()=>{l&&(window.clearTimeout(l),l=null)})},b=()=>{const d=h(i),v=h(i-2),m=h(i+1),f=h(i-1),x=h(i+2);n.innerHTML=k(d),a.innerHTML=g(v,u(i-2),v.description),s.innerHTML=g(m,u(i+1),m.description),o.innerHTML=g(f,u(i-1),f.description),c.innerHTML=g(x,u(i+2),x.description),y(a),y(s),y(o),y(c),r.forEach(($,E)=>{$.classList.toggle("active",E===i)})};e.addEventListener("click",()=>{i=u(i-1),b()}),t.addEventListener("click",()=>{i=u(i+1),b()}),r.forEach(d=>{d.addEventListener("click",()=>{i=Number(d.dataset.index||0),b()})}),b()}initTestimonialsCarousel(){const e=document.getElementById("carouselTrack"),t=document.getElementById("carouselPrev"),n=document.getElementById("carouselNext"),a=document.querySelectorAll(".carousel-dot");if(!e||!t||!n)return;let s=0;const o=this.data.testimonials.length,c=r=>{e.style.transform=`translateX(-${r*100}%)`,a.forEach((p,i)=>p.classList.toggle("active",i===r))};t.addEventListener("click",()=>{s=(s-1+o)%o,c(s)}),n.addEventListener("click",()=>{s=(s+1)%o,c(s)}),a.forEach(r=>{r.addEventListener("click",()=>{s=Number(r.dataset.index||0),c(s)})})}openModal(e){var t;(t=document.getElementById("authModal"))==null||t.remove(),document.body.insertAdjacentHTML("beforeend",this.renderAuthModal(e)),requestAnimationFrame(()=>{var n;(n=document.getElementById("authModal"))==null||n.classList.add("show"),this.attachModalListeners()})}attachModalListeners(){var t,n,a,s;const e=document.getElementById("authModal");e&&((t=e.querySelector(".modal-close"))==null||t.addEventListener("click",()=>{e.classList.remove("show"),setTimeout(()=>e.remove(),250)}),e.addEventListener("click",o=>{o.target===e&&(e.classList.remove("show"),setTimeout(()=>e.remove(),250))}),(n=document.getElementById("switchToLogin"))==null||n.addEventListener("click",o=>{o.preventDefault(),e.remove(),this.openModal("login")}),(a=document.getElementById("switchToRegister"))==null||a.addEventListener("click",o=>{o.preventDefault(),e.remove(),this.openModal("register")}),(s=document.getElementById("authForm"))==null||s.addEventListener("submit",o=>{o.preventDefault(),alert("Дякуємо! Перевірте вашу пошту для підтвердження."),e.classList.remove("show"),setTimeout(()=>e.remove(),250)}))}}document.addEventListener("DOMContentLoaded",()=>{new L().render()});
